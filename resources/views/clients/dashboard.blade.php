...
<div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-1 bg-white rounded-xl shadow-md p-6">
            <h3 class="text-xl font-semibold mb-4 text-gray-700">Status Laporan</h3>
            <hr class="mb-4">
...
@section('scripts')
        ...
        <script>
            ...
            const dataPending = {{ $laporanPending ?? 0 }};
            const dataWorking = {{ $laporanWorking ?? 0 }};
            const dataDone = {{ $laporanDone ?? 0 }};
            const dataRejected = {{ $laporanRejected ?? 0 }};
            ...
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ['Pending', 'Working', 'Done', 'Rejected'],
                    datasets: [{
                        label: 'Jumlah Laporan',
                        data: [dataPending, dataWorking, dataDone, dataRejected],
                        backgroundColor: [
                            'rgba(180, 187, 198, 0.8)',
                            'rgba(245, 158, 11, 0.8)',
                            'rgba(33, 236, 131, 0.8)',
                            'rgba(185, 36, 16, 0.8)',
                        ],
