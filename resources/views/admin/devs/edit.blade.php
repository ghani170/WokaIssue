...
<div class="mx-auto mt-1">
    ...
    <h2 class="text-2xl font-semibold mb-4">Tambah Developer</h2>

    <form action="{{ route('admin.developer.update', $dev->id) }}" method="POST"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name"
                ...
                value="{{ $dev->name }}" placeholder="Masukan Nama">
        ...
        <div class="mb-4">
            ...
            <input type="email" id="email" name="email"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2
                focus:ring-black focus:border-black transition"
                value="{{ $dev->email }}" placeholder="Masukan Email">
